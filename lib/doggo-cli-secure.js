            ...
            switch (cmd) {
                ...
                case 'create':
                    ...
                    (() => {
                        ...
                        Hoek.assert(secureType === 'password' || secureType === 'file' || secureType === 'text' || secureType === 'json');
                            ...
                            targetAssertPromise = new Promise((resolve, reject) => {
                                ...
                                switch (targetType) {
                                    ...
                                    case 'group':
                                        ...
                                        break;
                                    case 'organization':
                                        targetAssertPromise = dbUtils.assertExists('Organizations', { name: targetName })
                                        .catch(dbUtils.onErrorDestroy);
                                }
                            });
                        }
                            ...
                            .then((user) => {
                                ...
                                .then((remote) => {
                                    ...
                                    (err) => {
                                        ...
                                        DoggoNative.encryptTextFor(user.fingerprint, JSON.stringify(secureItem))
