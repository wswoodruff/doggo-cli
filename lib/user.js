...
module.exports = (Program, DoggoNative) => {
    ...
    const utils = require('./utils')(Program, DoggoNative);
    const dbUtils = require('./db')(Program, DoggoNative);
    const doggoClient = require('./client')(Program, DoggoNative);
    const db = dbUtils.db;
                                ...
                                if (promptRes.areYouSure === 'yes' ||
                                    ...
                                    .then(() => {
                                        ...
                                        .then(() => {
                                            ...
                                            DoggoNative.getFingerprintFor(`${user.name}`)
                                            .then((res) => {

                                                DoggoNative.removeAllKeysFor(res.fingerprint)
                                                .then(() => {
                        ...
                        if (cmd === 'up') {
                            ...
                            .then((foundUser) => {
                                ...
                                .then((foundRemote) => {
                                    ...
                                    DoggoNative.getKey(foundUser.fingerprint, 'secret')
                                    .then((sKey) => {
                            ...
                            .then((foundRemote) => {
                                ...
                                .then((res) => {
                                    ...
                                    DoggoNative.importKey(res.secureItem.sKey)
                                    .then((importRes) => {
    ...
    internals.addUser = (username, email, password) => {
        ...
        DoggoNative.getFingerprintFor(`${username}`)
        .then((res) => {

            DoggoNative.getKey(res.fingerprint, 'public')
            .then((publicKey) => {
