...
exports.start = async (options) => {
    ...
    switch (command) {
        ...
        case 'remote':
            ...
            path = path || DOGGO_DISH_DEFAULT_REMOTE_PATH;
            ...
            switch (subCommand) {
                ...
                case 'sync':
                    ...
                    const jwt = await RemoteManager.getJwt(path, user, password);



                    // const userSecret = await RemoteManager.getSecretForUser(jwt, path, 'doggo-test');
                    // const userSecret = await RemoteManager.getSecretForUser(jwt, path, 'newbie');
